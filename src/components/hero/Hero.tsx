...
const TOAST: Record<ToastType, ToastConfig> = {
  success: {
    message: 'Thank you for signing up! You will be the first to know when TripTales launches.',
    position: 'top-center',
    duration: 6000,
  },
  error: {
  ...
  return (
    <section className="hero">
      ...
      <div className="hero__top">
        <div className="hero__container">
          <div className="hero__text">
            <h1 className="hero__heading">Plan, Discover, and Share Your Journey</h1>
      ...
      <div className="hero__form">
        <div className={isSubmitted ? 'hero__form__titleSuccess' : 'hero__form__container'}>
          {!isSubmitted ? (
            <>
              <h2 className="hero__formTitle">Be Among the First to Explore TripTales</h2>
              ...
              <label className="hero__checkbox">
                <input
                  ...
                  onChange={handleChange}
                />
                <span>TripTales may contact me for feedback on design and features</span>
              </label>
            </>
          ) : (
